...
for m_ in m_seed:
    ...
    for ego_user in G_EGO_USERS:
        ...
        METHOD='gcn'
        savepath = res_dir0+ METHOD + '-disconnected_edges_sampled-triangle' + Flag + '-' + str(ego_user)+'-new-629-lap-multi'+str(m_)+'.npy'
        print('***')
        disconnected_edges_sampled=np.load(savepath)


        METHOD = 'gcn'
        savepath = res_dir0 + METHOD + '-pos_sampled-triangle' + Flag + '-' + str(ego_user) + '-new-629-lap-multi'+str(m_)+'.npy'
        print('***')
        ...
        non_mem_class = np.array([0] * 2*int(idx_min_/2) + [1] * num_triad)
        print(non_mem_class)
        ...
        neg_sampled0=neg_sampled[0:int(num_triad/2)]
        neg_sampled1=neg_sampled[int(num_triad/2):int(1*num_triad)]
        neg_sampled2=neg_sampled[int(1*num_triad):int(2*num_triad)]

        y_label_neg0=y_label_neg[0:int(num_triad/2)]
        y_label_neg1 = y_label_neg[int(num_triad/2):int(1*num_triad)]
        y_label_neg2 = y_label_neg[int(1*num_triad):int(2*num_triad)]
