        ...
        for ratio in ratios:
            ...
            for ego_user in G_EGO_USERS:
                ...
                savepath = res_dir0 + METHOD + '-disconnected_edges_sampled-4clique' + Flag + '-' + str(
                    ego_user) + '-new-629-lap-multi6.npy'
                print('***')
                ...
                for b in sigmas:
                    ...
                    non_mem_class = np.array(
                        [0] * int(5 * int(idx_min_ / 9)) + [1] * idx_min_ + [0] * int(4 * int(idx_min_ / 9)))
                    ...
                    X_test = np.concatenate(
                        (X_train_test, X_test_test0, X_test_test1, X_test_test2, X_test_test3, X_test_test4,
                    ...
                    y_test = np.concatenate(
                        (y_train_test, y_test_test0, y_test_test1, y_test_test2, y_test_test3, y_test_test4,
