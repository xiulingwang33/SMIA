    ...
    for target in targets:
        ...
        for ratio in ratios:
            ...
            for ego_user in G_EGO_USERS:
                ...
                METHOD='gcn'
                savepath = res_dir+ METHOD + '-disconnected_edges_sampled-'+target + Flag + '-' + str(ego_user)+'-new-629-lap-multi.npy'
                print('***')
                disconnected_edges_sampled=np.load(savepath)


                METHOD = 'gcn'
                savepath = res_dir + METHOD + '-pos_sampled-'+target + Flag + '-' + str(ego_user) + '-new-629-lap-multi.npy'
                print('***')
                ...
                for b in sigmas:
                    ...
                    # sigma = 50
                    if dp == 7:
                        Flag = '114-gcn-' + str(ego_user) + '-' + str(dp) + '-' + str(b) + '-' + str(ratio)
