    ...
    for target in targets:
        ...
        for ratio in ratios:
            ...
            for ego_user in G_EGO_USERS:
                ...
                METHOD='gcn'
                savepath = res_dir0+ METHOD + '-disconnected_edges_sampled-'+target + Flag + '-' + str(ego_user)+'-new-629-lap-multi.npy'
                print('***')
                disconnected_edges_sampled=np.load(savepath)


                METHOD = 'gcn'
                savepath = res_dir0 + METHOD + '-pos_sampled-'+target + Flag + '-' + str(ego_user) + '-new-629-lap-multi.npy'
                print('***')
