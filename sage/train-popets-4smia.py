...
for m_ in m_seed:
    ...
    for ego_user in G_EGO_USERS:
        ...
        with open("{}/mlp_4cliq-w-new-629-multi-{}.pkl".format(res_dir,str(m_)), "wb") as f2:
            pkl.dump(mlp, f2)
        ...
        result.to_csv("{}/mlp_sim-4clique-w-new-629-multi-{}.csv".format(res_dir,str(m_)))
        ...
        mlp.fit(X_train, y_train[:, 0])
        with open("{}/mlp_4cliq-b-new-629-multi-{}.pkl".format(res_dir,str(m_)), "wb") as f2:
            pkl.dump(mlp, f2)
        ...
        name = ['y_score', 'prob', 'y_test_grd', 'y_test_class', '0']
        result = pd.DataFrame(columns=name, data=tsts)
        result.to_csv("{}/mlp_sim-4clique-b-new-629-multi-{}.csv".format(res_dir,str(m_)))
    ...
    result.to_csv("{}/pmia-results-4cliq-new-629-multi-{}.csv".format(args.dataset,str(m_)))
